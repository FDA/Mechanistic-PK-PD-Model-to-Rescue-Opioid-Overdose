...
outputFolder=paste0("output/",inputs$antagonistAdministrationRouteAndDose,"/","populationOutput",inputs$antagonistAdministrationTimeCase,todaysDate, "/", modelOutputFolder, "/RT")
