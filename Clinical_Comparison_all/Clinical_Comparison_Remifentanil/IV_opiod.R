...
ggsave(paste0("figs/",patien_case,"_Remifentanil_Rev01_EB_New_EQ_P2_",P2,"_P1_",P1,"_k1_",k1,"_bar_Var_No_Cov_lims_90CI.pdf"), pall1, width=8, height=6)

ggsave(paste0("figs/",patien_case,"_Remifentanil_justp4_Rev01_EB_NE_EQ",P2,"_P1_",P1,"_k1_",k1,"_bar_Var_No_Cov_lims_PK_90CI.pdf"), p4, width=8, height=6)
