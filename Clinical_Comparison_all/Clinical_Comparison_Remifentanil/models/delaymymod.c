...
#define Infu_t parms[19]
#define VF parms[20]
#define timeout parms[21]
#define starttime parms[22]
...
ydot[5] = -(kout*y[5])-(k12*y[5])+(k21*y[6])+(k31*y[7])-(k13*y[5])+(y[11]/Infu_t);
ydot[6] = (k12*y[5])-(k21*y[6]);
ydot[7] = (k13*y[5])-(k31*y[7]);
ydot[8] = (k1*1e6*y[5]*1000/VF/Mmass)-(k1*y[8]);
