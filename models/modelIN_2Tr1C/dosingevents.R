...
dosingevents<-function(
	...
	if(!identical(antagonistDoses[antagonistDoseIndex], character(0)) && antagonistDoses[antagonistDoseIndex] == "1 dose"){
		if (antagonistDosesLabels[antagonistDoseIndex] == "1 scaled dose"){
	...
	}else if(!identical(antagonistDoses[antagonistDoseIndex], character(0)) && antagonistDoses[antagonistDoseIndex] == "2 doses"){
	...
	}else if(!identical(antagonistDoses[antagonistDoseIndex], character(0)) && antagonistDoses[antagonistDoseIndex] == "3 doses"){
	...
	}else if(!identical(antagonistDoses[antagonistDoseIndex], character(0)) && antagonistDoses[antagonistDoseIndex] == "4 doses"){
	...
	}else if(!identical(antagonistDoses[antagonistDoseIndex], character(0)) && antagonistDoses[antagonistDoseIndex] == "4 doses, rapid"){
