...
namesyout<-c("Minute ventilation (l/min)","Residual wakefulness drive (l/min)","Chemoreflex drive (l/min)",
		...
		"Arterial O2 saturation (%)", "Fentanyl VoD", "Naloxone VoD",
		"C_a_o2", "C_e_o2", "C_V_o2", "C_Vb_o2", "C_Vt_o2",
		"C_a_co2", "C_e_co2", "C_V_co2", "C_Vb_co2", "C_Vt_co2",
		"P_T_o2", "P_T_co2", "Arterial O2 saturation (%) alternate"
)