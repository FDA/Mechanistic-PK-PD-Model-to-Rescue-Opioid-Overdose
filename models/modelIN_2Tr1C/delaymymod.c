...
void derivs (int *neq, double *t, double *y, double *ydot, double *yout, int *ip){
	...
	//Opioid PK====(Method 2)
	ydot[5] = -(koutC*y[5])-(k12C*y[5])+(k21C*y[6])+(k31C*y[7])-(k13C*y[5])+y[23]/Infu_t; //(in ng/s)
	ydot[6] = (k12C*y[5])-(k21C*y[6]); //(in ng/s)
	ydot[7] = (k13C*y[5])-(k31C*y[7]); //(in ng/s)
	...
	yout[9]=((y[5])/(VPC*1e3)); /*Opioid plasma concentration (ng/mL)*/
