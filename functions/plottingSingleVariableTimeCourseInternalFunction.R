...
#on: 2023-06-13
plottingSingleVariableTimeCourseInternalFunction<-function(
	...
	plottedAntagonistDoseIndices<-c(1, 2, 3, 4)
	labels="off" #"on"
	...
	plot <- plot+ geom_line(aes(x=pp[[1]][[4]][1:timeIndexUL[4],"time"]/60, y=pp[[1]][[4]][1:timeIndexUL[4], myvar], color="g"), size=1, linetype="solid") #"twodash"
	plot <- plot+ geom_line(aes(x=pp[[1]][[3]][1:timeIndexUL[3],"time"]/60, y=pp[[1]][[3]][1:timeIndexUL[3], myvar], color="e"), size=1, linetype="solid") #"dashed" @"dotdash"
	plot <- plot+ geom_line(aes(x=pp[[1]][[2]][1:timeIndexUL[2],"time"]/60, y=pp[[1]][[2]][1:timeIndexUL[2], myvar], color="c"), size=1, linetype="dashed") #"solid" #"dashed"
	...
	plot <- plot+ geom_point(aes(x=pp[[1]][[4]][timeIndexUL[4],"time"]/60,pp[[1]][[4]][timeIndexUL[4], myvar]), shape=4, color="black", size=4, stroke = 3)
	#======================================================================================================================"X"s to indicate cardiac arrest
