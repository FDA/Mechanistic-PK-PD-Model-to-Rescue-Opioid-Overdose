...
outputCase1=read.csv(sprintf("output/%s/optimalOutput%s/%s_%s_%s_%s_%s_%s_%s_%s,%smins/APC.csv",		 	antagonistAdministrationRoutesAndDoses[1], inputs$inputDate, inputs$opioid, inputs$opioidDose, inputs$opioidDosingRoute, inputs$opioidInfusionRate, inputs$opioidAbsorptionRate, inputs$fractionOfBaselineVentilationForAntagonistAdministration, inputs$subjectType, inputs$subjectAge, simulationTime))
outputCase2=read.csv(sprintf("output/%s/optimalOutput%s/%s_%s_%s_%s_%s_%s_%s_%s,%smins/APC.csv",		 	antagonistAdministrationRoutesAndDoses[2], inputs$inputDate, inputs$opioid, inputs$opioidDose, inputs$opioidDosingRoute, inputs$opioidInfusionRate, inputs$opioidAbsorptionRate, inputs$fractionOfBaselineVentilationForAntagonistAdministration, inputs$subjectType, inputs$subjectAge, simulationTime))
outputCase3=read.csv(sprintf("output/%s/optimalOutput%s/%s_%s_%s_%s_%s_%s_%s_%s,%smins/APC.csv",		 	antagonistAdministrationRoutesAndDoses[3], inputs$inputDate, inputs$opioid, inputs$opioidDose, inputs$opioidDosingRoute, inputs$opioidInfusionRate, inputs$opioidAbsorptionRate, inputs$fractionOfBaselineVentilationForAntagonistAdministration, inputs$subjectType, inputs$subjectAge, simulationTime))
outputCase4=read.csv(sprintf("output/%s/optimalOutput%s/%s_%s_%s_%s_%s_%s_%s_%s,%smins/APC.csv",		 	antagonistAdministrationRoutesAndDoses[4], inputs$inputDate, inputs$opioid, inputs$opioidDose, inputs$opioidDosingRoute, inputs$opioidInfusionRate, inputs$opioidAbsorptionRate, inputs$fractionOfBaselineVentilationForAntagonistAdministration, inputs$subjectType, inputs$subjectAge, simulationTime))
...
for (antagonistAdministrationRouteAndDose in antagonistAdministrationRoutesAndDoses){
	...
	ggsave(sprintf("%s/renarcotization4APC_%s.jpg", outputFolder, timeToPlot), plot, height = 2.5, width = 5)
}